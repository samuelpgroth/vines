...
Tx.a2 = 3.3/2;		% outer radius (cm)
Tx.d = 3.5;		% geometric focus (cm) [= Inf if planar array]
...
Layer(1).c = 1480;	% small-signal sound speed (m/s)
Layer(1).rho = 1000;	% mass density (kg/m^3)
Layer(1).alpha = 0.2;	% attenuation at 1MHz (dB/m)
